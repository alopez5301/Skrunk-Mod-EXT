...
class SkrunksEasyTFR(QWidget):
    ...
    def auto_fill_values(self):
        ...
        try:
            ...
            r200 = r70 + 0.001
            r600 = 0.79 
            r800_multiplier = 1.20
            
            r800 = r600 * r800_multiplier
            ...
            for temp in self.temperatures_auto:
                if temp == 70:
                    ...
                    r200 = r70 + 0.001
                    self.value_inputs[200].setText(f"{r200:.3f}")
                elif temp == 600:
                    self.value_inputs[600].setText("0.79")
                elif temp == 800:
                    self.value_inputs[800].setText(f"{r800:.3f}")
                else:
                    progress = (temp - 200) / (600 - 200)
                    curve_factor = progress ** 2  
                    res_value = r200 + ((r600 - r200) * curve_factor)
        ...
        try:
            ...
            if (self.extrapolateCheck.isChecked() or self.radio_auto.isChecked()) and 800 in self.current_temperatures:
                ...
                if prev_temp_idx >= 0:
                    ...
                    coefficients[idx_800] = (800, round(prev_coef * 1.05, 3))
